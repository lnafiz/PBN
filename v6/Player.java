...
public class Player extends Gambler{
  ...
  public boolean nextMove(){
    ...
    if (input == 0){
      ...
      System.out.println("\n\n Once your turn ends, wait for the bots to play through their game to determine who's the winner. If your hand is not the greatest, it's a bust, and you lose. If it's the greatest, Congratulations! You just won the game!"); 
      System.out.println("\n\n To play this game, you spend credits. Credits work similar to tokens. You start out every game with 10 credits. Every game you play in a session requires 1 token as payment."); 
